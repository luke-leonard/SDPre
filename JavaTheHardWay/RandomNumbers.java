public class RandomNumbers
{
  public static void main(String[] args)
  {
    ...
    System.out.println("0-3:\t" + ((int)(Math.random()*3) + 1) + "\t" + ((int)(Math.random()*3) + 1) + "\t" + ((int)(Math.random()*3) + 1 ) );
    System.out.println("5-10:\t" + ((int)(Math.random()*5) + 5) + "\t" + ((int)(Math.random()*5) + 5) + "\t" + ((int)(Math.random()*5) + 5 ) );
  }
}
